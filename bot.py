...
def generate_life_weeks_image(birth_date, current_date, life_expectancy_years=80):
    ...
    remaining_days = life_expectancy_years * 365 - lived_days
...
def handle_message(message):
    ...
    if user_id in awaiting_birth_date_change:
        ...
        bot.send_message(message.chat.id, "Ты уже добавил дату рождения. Чтобы изменить её, нажми кнопку в меню /start.")
